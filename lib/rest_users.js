...
/**
 *  /users/metadata/set - Sets values in all the user profiles (POST)
 */
...
/**
 *  /users/:name/metadata - Gets the user profile
 */
app.get('/' + aofn.config.db.users.label + '/:user/' + aofn.config.metadata, function (req, res) {
    aofn.debugSTART(req);

    aofn.authorize(req, res, function (req, res) {
        req.params.user = aofn.userNRULE(req.params.user);
...
/**
 *  /users/:name/metadata/set - Sets values in the user profile (POST)
 */
...
app.get('/' + aofn.config.db.users.label + '/:name/:pwd/validate', function (req, res) {
    ...
    aofn.authorize(req, res, function (req, res) {
        req.params.name = aofn.userNRULE(req.params.name);
        req.params.pwd = aofn.userNRULE(req.params.pwd);
...
app.get('/' + aofn.config.db.users.label + '/:name/:pwd', function (req, res) {
    ...
    aofn.authorize(req, res, function (req, res) {
        req.params.name = aofn.userNRULE(req.params.name);
        req.params.pwd = aofn.userNRULE(req.params.pwd, true);

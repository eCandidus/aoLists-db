                                    ...
                                    if (err) {
                                        ...
                                        if (aofn.config.enableATTACH) {
                                            ...
                                            if (aofn.config.enableDESC) {
                                                extraA = aofn.queryATTX(aofn.config.db.attach.fields.desccfld, doc[aofn.config.db.fields.desc]);
                                            }
                                            var setA = aofn.queryATTX(aofn.config.db.attach.fields.vercfld, doc[aofn.config.db.fields.ver], extraA);
                                            var queryP = aofn.queryATTPARENT(aofn.attachKEY(req.params.db, req.params.collection, req.params.id));
                                            var extraP;
                                            if (aofn.config.enableDESC) {
                                                extraP = aofn.queryATTX(aofn.config.db.attach.fields.descpfld, doc[aofn.config.db.fields.desc]);
                                            }
                                            var setP = aofn.queryATTX(aofn.config.db.attach.fields.verpfld, doc[aofn.config.db.fields.ver], extraP);
